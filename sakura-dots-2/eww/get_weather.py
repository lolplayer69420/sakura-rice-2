...
def get_weather(coordinates: str, fetch: str) -> str:
    url = f"https://api.tomorrow.io/v4/timelines?location={coordinates}&fields=temperature,weatherCode&timesteps=1h&units=metric&apikey=AZLOFUARvXVXX9QN5Mj4CRdnvXDKUM6Y"
...
subprocess.call(["echo", f"{OPTIONS[sys.argv[1:][0]]('4.7305555555556,-74.263888888889')}"])
